        ...
        if (this.pad) {
            ...
            if (this.pad.R2 > 0) {
                ...
                if (time - this.getData('lastShotTime') > this.getData('shootCooldown')) {
                    ...
                    this.emit('shoot', this, this.x, this.y, facing.x*BULLET_SPEED, facing.y*BULLET_SPEED);
                }
            }
...
var TopdownTest2 = new Phaser.Class({
    ...
    create: function ()
    {
        ...
        this.player.on('shoot', this.onShoot, this);
        this.player2.on('shoot', this.onShoot, this);
    ...
    onShoot: function (player, x, y, dir_x, dir_y) {
